...
<body class="hold-transition skin-purple-light sidebar-mini" style="overflow:hidden;">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <nav class="navbar navbar-static-top">
                ...
                </a><span class="index_top"><strong>XXX样例</strong></span>
        ...
        <div id="content-wrapper" class="content-wrapper">
            <div class="content-tabs">
                ...
                <nav class="page-tabs menuTabs">
                    <div class="page-tabs-content" style="margin-left: 0px;">
                        <a href="javascript:;" class="menuTab active" data-id="/standard/welcome">起始</a>
                    </div>
                </nav>
            ...
            <div class="content-iframe" style="overflow: hidden;">
                <div class="mainContent" id="content-main" style="margin: 10px; margin-bottom: 0px; padding: 0;">
                    <iframe class="LRADMS_iframe" width="100%" height="100%" src="/standard/welcome" frameborder="0" data-id="/standard/welcome"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="/static/js/standard/main.js"></script>
</body>
</html>
